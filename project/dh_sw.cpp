...
)
{
  ...
  /* Set reference values for verification */
  NN_HALF_DIGIT aHighRef = aHigh;
  NN_DIGIT tRef[2]; tRef[0] = t[0]; tRef[1] = t[1];
  ...
  if (t[0] != tRef[0]) cout << "t[0] = " << t[0] << " --- expected: " << tRef[0] << endl << endl;
  if (t[1] != tRef[1]) cout << "t[1] = " << t[1] << " --- expected: " << tRef[1] << endl << endl;
  if (aHigh != aHighRef) cout << "aHigh = " << aHigh << " --- expected: " << aHighRef << endl << endl;
