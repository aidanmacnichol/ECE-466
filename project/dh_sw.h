...
SC_MODULE (dh_sw)
{
  ...
  sc_in <NN_DIGIT> from_hw0, from_hw1;
  sc_in <NN_HALF_DIGIT> from_hw2;
...
/*********************************************************************/
  ...
  void NN_DigitDivHH (NN_HALF_DIGIT &, NN_DIGIT[2], NN_DIGIT);
  void NN_DigitDivHH_Ref (NN_HALF_DIGIT &, NN_DIGIT[2], NN_DIGIT);
